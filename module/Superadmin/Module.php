 ...
 * Module Superadmin
 *
 * Sets up and configures the Superadmin module
 *
 * @package Superadmin
 */
class Module implements InitProviderInterface, ConfigProviderInterface, AutoloaderProviderInterface
{
    ...
    {
        if (!defined('SUPERADMIN_MODULE_ROOT')) {
            define('SUPERADMIN_MODULE_ROOT', realpath(__DIR__));
        }
    }
        ...
        return array(
            ...
            'Zend\\Loader\\StandardAutoloader' => array(
                'namespaces' => array(
                    ...
                    'Superadmin\Navigator\Service' => __DIR__ . '/navigator/service',
                ),
            ),
        );
    }
