...
class EnseignantsmoduleTable extends AbstractTableGateway
{
    protected $table ='enseignantsmodule';
    protected $tableName ='enseignantsmodule';
    ...
    public function __construct(Adapter $adapter)
    {
        ...
        $this->resultSetPrototype = new ResultSet(new Enseignantsmodule);
